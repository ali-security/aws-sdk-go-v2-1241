...
import (
	...
	"github.com/aws/smithy-go/smithy-http-protocols/rpcv2"
...
const serviceName = "QueryCompatibleRpcV2Protocol"
...
resolveMeterProvider(&options)
    ...
    options.Protocol = rpcv2.NewCBOR(rpcv2.UseQueryCompatible)
