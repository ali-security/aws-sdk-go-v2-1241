...
func (v *GetItemInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_GetItemInput)
	s.CloseMap()
}
func (v *GetItemInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_GetItemInput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (v *GetItemOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_GetItemOutput)
	s.CloseMap()
}
func (v *GetItemOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_GetItemOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationGetItemMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.GetItem, schemas.SmithyGoSynthetic_GetItemInput, schemas.SmithyGoSynthetic_GetItemOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.GetItem, schemas.SmithyGoSynthetic_GetItemInput, schemas.SmithyGoSynthetic_GetItemOutput), output: &GetItemOutput{}}, middleware.After); err != nil {
	    return err
	}
