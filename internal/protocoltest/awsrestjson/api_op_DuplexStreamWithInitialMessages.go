...
func (c *Client) DuplexStreamWithInitialMessages(ctx context.Context, params *DuplexStreamWithInitialMessagesInput, optFns ...func(*Options)) (*DuplexStreamWithInitialMessagesOutput, error) {
	if params == nil { params = &DuplexStreamWithInitialMessagesInput{} }
...
func (v *DuplexStreamWithInitialMessagesInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesInput)
	s.WriteStringPtr(schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesInput_initialRequestMember, v.InitialRequestMember)
	s.CloseMap()
}
...
func (v *DuplexStreamWithInitialMessagesOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesOutput)
	s.CloseMap()
}
func (v *DuplexStreamWithInitialMessagesOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationDuplexStreamWithInitialMessagesMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DuplexStreamWithInitialMessages, schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesInput, schemas.SmithyGoSynthetic_DuplexStreamWithInitialMessagesOutput)}, middleware.After); err != nil {
	    return err
	}
