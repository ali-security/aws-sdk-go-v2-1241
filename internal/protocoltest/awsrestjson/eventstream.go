...
if m.options.Protocol.HasInitialEventMessage() {
    ...
    if err = m.options.Protocol.SerializeInitialRequest(schemas.SmithyGoSynthetic_DuplexStreamWithDistinctStreamsInput, opInput, inputStreamWriter); err != nil {
...
if m.options.Protocol.HasInitialEventMessage() {
    ...
    if err = m.options.Protocol.SerializeInitialRequest(schemas.SmithyGoSynthetic_InputStreamInput, opInput, inputStreamWriter); err != nil {
        return out, md, fmt.Errorf("serialize initial request: %w", err)
    }
}
...
if m.options.Protocol.HasInitialEventMessage() {
    ...
    if err = m.options.Protocol.SerializeInitialRequest(schemas.SmithyGoSynthetic_InputStreamWithInitialRequestInput, opInput, inputStreamWriter); err != nil {
        return out, md, fmt.Errorf("serialize initial request: %w", err)
    }
}
