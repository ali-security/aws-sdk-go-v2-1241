...
func (v *HttpRequestWithGreedyLabelInPathInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput)
	s.WriteStringPtr(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_baz, v.Baz)
	s.WriteStringPtr(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_foo, v.Foo)
	s.CloseMap()
}
func (v *HttpRequestWithGreedyLabelInPathInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput, func(s *smithy.Schema) error {
		switch s {
			case schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_baz:
			return d.ReadStringPtr(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_baz, &v.Baz)
			case schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_foo:
			return d.ReadStringPtr(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput_foo, &v.Foo)
		}
		return nil
	})
}
...
func (v *HttpRequestWithGreedyLabelInPathOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathOutput)
	s.CloseMap()
}
func (v *HttpRequestWithGreedyLabelInPathOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationHttpRequestWithGreedyLabelInPathMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.HttpRequestWithGreedyLabelInPath, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.HttpRequestWithGreedyLabelInPath, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathInput, schemas.SmithyGoSynthetic_HttpRequestWithGreedyLabelInPathOutput), output: &HttpRequestWithGreedyLabelInPathOutput{}}, middleware.After); err != nil {
	    return err
	}
