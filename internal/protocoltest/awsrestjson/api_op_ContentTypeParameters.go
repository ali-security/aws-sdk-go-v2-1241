...
func (v *ContentTypeParametersInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_ContentTypeParametersInput)
	s.WriteInt32Ptr(schemas.SmithyGoSynthetic_ContentTypeParametersInput_value, v.Value)
	s.CloseMap()
}
...
func (v *ContentTypeParametersOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_ContentTypeParametersOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationContentTypeParametersMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ContentTypeParameters, schemas.SmithyGoSynthetic_ContentTypeParametersInput, schemas.SmithyGoSynthetic_ContentTypeParametersOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ContentTypeParameters, schemas.SmithyGoSynthetic_ContentTypeParametersInput, schemas.SmithyGoSynthetic_ContentTypeParametersOutput), output: &ContentTypeParametersOutput{}}, middleware.After); err != nil {
	    return err
	}
