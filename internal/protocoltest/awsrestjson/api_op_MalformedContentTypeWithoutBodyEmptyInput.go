...
func (v *MalformedContentTypeWithoutBodyEmptyInputInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput)
	s.WriteStringPtr(schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput_header, v.Header)
	s.CloseMap()
}
func (v *MalformedContentTypeWithoutBodyEmptyInputInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput, func(s *smithy.Schema) error {
		switch s {
			case schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput_header:
			return d.ReadStringPtr(schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput_header, &v.Header)
		}
		return nil
	})
}
...
func (v *MalformedContentTypeWithoutBodyEmptyInputOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputOutput)
	s.CloseMap()
}
func (v *MalformedContentTypeWithoutBodyEmptyInputOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationMalformedContentTypeWithoutBodyEmptyInputMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.MalformedContentTypeWithoutBodyEmptyInput, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.MalformedContentTypeWithoutBodyEmptyInput, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputInput, schemas.SmithyGoSynthetic_MalformedContentTypeWithoutBodyEmptyInputOutput), output: &MalformedContentTypeWithoutBodyEmptyInputOutput{}}, middleware.After); err != nil {
	    return err
	}
