...
func (v *DuplexStreamInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_DuplexStreamInput)
	s.CloseMap()
}
...
func (v *DuplexStreamOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_DuplexStreamOutput)
	s.CloseMap()
}
func (v *DuplexStreamOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_DuplexStreamOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationDuplexStreamMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DuplexStream, schemas.SmithyGoSynthetic_DuplexStreamInput, schemas.SmithyGoSynthetic_DuplexStreamOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.DuplexStream, schemas.SmithyGoSynthetic_DuplexStreamInput, schemas.SmithyGoSynthetic_DuplexStreamOutput), output: &DuplexStreamOutput{}}, middleware.After); err != nil {
	    return err
	}
