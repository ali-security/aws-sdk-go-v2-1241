...
func (v *ResponseCodeHttpFallbackInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackInput)
	s.CloseMap()
}
func (v *ResponseCodeHttpFallbackInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackInput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (v *ResponseCodeHttpFallbackOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackOutput)
	s.CloseMap()
}
func (v *ResponseCodeHttpFallbackOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationResponseCodeHttpFallbackMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ResponseCodeHttpFallback, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackInput, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ResponseCodeHttpFallback, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackInput, schemas.SmithyGoSynthetic_ResponseCodeHttpFallbackOutput), output: &ResponseCodeHttpFallbackOutput{}}, middleware.After); err != nil {
	    return err
	}
