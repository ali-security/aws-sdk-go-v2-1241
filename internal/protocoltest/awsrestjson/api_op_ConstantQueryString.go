...
func (v *ConstantQueryStringInput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_ConstantQueryStringInput)
	s.WriteStringPtr(schemas.SmithyGoSynthetic_ConstantQueryStringInput_hello, v.Hello)
	s.CloseMap()
}
func (v *ConstantQueryStringInput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_ConstantQueryStringInput, func(s *smithy.Schema) error {
		switch s {
			case schemas.SmithyGoSynthetic_ConstantQueryStringInput_hello:
			return d.ReadStringPtr(schemas.SmithyGoSynthetic_ConstantQueryStringInput_hello, &v.Hello)
		}
		return nil
	})
}
...
func (v *ConstantQueryStringOutput) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SmithyGoSynthetic_ConstantQueryStringOutput)
	s.CloseMap()
}
func (v *ConstantQueryStringOutput) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SmithyGoSynthetic_ConstantQueryStringOutput, func(s *smithy.Schema) error {
		switch s {
		}
		return nil
	})
...
func (c *Client) addOperationConstantQueryStringMiddlewares(stack *middleware.Stack, options Options) (err error) {
	...
	if err := stack.Serialize.Add(&serializeRequestMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ConstantQueryString, schemas.SmithyGoSynthetic_ConstantQueryStringInput, schemas.SmithyGoSynthetic_ConstantQueryStringOutput)}, middleware.After); err != nil {
	    return err
	}
	if err := stack.Deserialize.Add(&deserializeResponseMiddleware{options: &options, operationSchema: smithy.NewOperationSchema(schemas.ConstantQueryString, schemas.SmithyGoSynthetic_ConstantQueryStringInput, schemas.SmithyGoSynthetic_ConstantQueryStringOutput), output: &ConstantQueryStringOutput{}}, middleware.After); err != nil {
	    return err
	}
