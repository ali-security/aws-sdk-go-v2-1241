...
func (v *EmptyStruct) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.EmptyStruct)
	s.CloseMap()
}
...
func (v *KitchenSink) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.KitchenSink)
	s.WriteBlob(schemas.KitchenSink_Blob, v.Blob)
	s.WriteBoolPtr(schemas.KitchenSink_Boolean, v.Boolean)
	s.WriteFloat64Ptr(schemas.KitchenSink_Double, v.Double)
	if (v.EmptyStruct != nil) { s.WriteStruct(schemas.KitchenSink_EmptyStruct, v.EmptyStruct) }
	s.WriteFloat32Ptr(schemas.KitchenSink_Float, v.Float)
	s.WriteTimePtr(schemas.KitchenSink_HttpdateTimestamp, v.HttpdateTimestamp)
	s.WriteInt32Ptr(schemas.KitchenSink_Integer, v.Integer)
	s.WriteTimePtr(schemas.KitchenSink_Iso8601Timestamp, v.Iso8601Timestamp)
	s.WriteStringPtr(schemas.KitchenSink_JsonValue, v.JsonValue)
	...
	s.WriteInt64Ptr(schemas.KitchenSink_Long, v.Long)
	...
	if (v.RecursiveStruct != nil) { s.WriteStruct(schemas.KitchenSink_RecursiveStruct, v.RecursiveStruct) }
	if (v.SimpleStruct != nil) { s.WriteStruct(schemas.KitchenSink_SimpleStruct, v.SimpleStruct) }
	s.WriteStringPtr(schemas.KitchenSink_String, v.String_)
	if (v.StructWithJsonName != nil) { s.WriteStruct(schemas.KitchenSink_StructWithJsonName, v.StructWithJsonName) }
	s.WriteTimePtr(schemas.KitchenSink_Timestamp, v.Timestamp)
	s.WriteTimePtr(schemas.KitchenSink_UnixTimestamp, v.UnixTimestamp)
	s.CloseMap()
}
func (v *KitchenSink) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.KitchenSink, func(s *smithy.Schema) error {
		switch s {
			...
			return d.ReadBoolPtr(schemas.KitchenSink_Boolean, &v.Boolean)
			case schemas.KitchenSink_Double:
			return d.ReadFloat64Ptr(schemas.KitchenSink_Double, &v.Double)
			...
			return d.ReadFloat32Ptr(schemas.KitchenSink_Float, &v.Float)
			case schemas.KitchenSink_HttpdateTimestamp:
			return d.ReadTimePtr(schemas.KitchenSink_HttpdateTimestamp, &v.HttpdateTimestamp)
			case schemas.KitchenSink_Integer:
			return d.ReadInt32Ptr(schemas.KitchenSink_Integer, &v.Integer)
			case schemas.KitchenSink_Iso8601Timestamp:
			return d.ReadTimePtr(schemas.KitchenSink_Iso8601Timestamp, &v.Iso8601Timestamp)
			case schemas.KitchenSink_JsonValue:
			return d.ReadStringPtr(schemas.KitchenSink_JsonValue, &v.JsonValue)
			...
			return d.ReadInt64Ptr(schemas.KitchenSink_Long, &v.Long)
			...
			return d.ReadStringPtr(schemas.KitchenSink_String, &v.String_)
			...
			return d.ReadTimePtr(schemas.KitchenSink_Timestamp, &v.Timestamp)
			case schemas.KitchenSink_UnixTimestamp:
			return d.ReadTimePtr(schemas.KitchenSink_UnixTimestamp, &v.UnixTimestamp)
		}
		return nil
	})
}
...
func (v *SimpleStruct) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.SimpleStruct)
	s.WriteStringPtr(schemas.SimpleStruct_Value, v.Value)
	s.CloseMap()
}
func (v *SimpleStruct) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.SimpleStruct, func(s *smithy.Schema) error {
		switch s {
			...
			return d.ReadStringPtr(schemas.SimpleStruct_Value, &v.Value)
		}
		return nil
	})
}
...
func (v *StructWithJsonName) Serialize(s smithy.ShapeSerializer) {
	s.WriteMap(schemas.StructWithJsonName)
	s.WriteStringPtr(schemas.StructWithJsonName_Value, v.Value)
	s.CloseMap()
}
func (v *StructWithJsonName) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.StructWithJsonName, func(s *smithy.Schema) error {
		switch s {
			...
			return d.ReadStringPtr(schemas.StructWithJsonName_Value, &v.Value)
		}
		return nil
	})
}
