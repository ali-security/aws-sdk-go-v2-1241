...
func (v *ErrorWithMembers) Deserialize(d smithy.ShapeDeserializer) error {
	return smithy.ReadStruct(d, schemas.ErrorWithMembers, func(s *smithy.Schema) error {
		switch s {
			...
			return d.ReadStringPtr(schemas.ErrorWithMembers_Code, &v.Code)
			...
			return d.ReadInt32Ptr(schemas.ErrorWithMembers_IntegerField, &v.IntegerField)
			...
			return d.ReadStringPtr(schemas.ErrorWithMembers_Message, &v.Message)
			case schemas.ErrorWithMembers_StringField:
			return d.ReadStringPtr(schemas.ErrorWithMembers_StringField, &v.StringField)
		}
		return nil
	})
}
