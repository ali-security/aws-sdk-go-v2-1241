...
type awsRestjson1_deserializeOpDeleteCampaignEntryLimits struct {
}

func (*awsRestjson1_deserializeOpDeleteCampaignEntryLimits) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpDeleteCampaignEntryLimits) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorDeleteCampaignEntryLimits(response, &metadata)
	}
	output := &DeleteCampaignEntryLimitsOutput{}
	out.Result = output
...
func awsRestjson1_deserializeOpErrorDeleteCampaignEntryLimits(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
type awsRestjson1_deserializeOpUpdateCampaignEntryLimits struct {
}

func (*awsRestjson1_deserializeOpUpdateCampaignEntryLimits) ID() string {
	return "OperationDeserializer"
}

func (m *awsRestjson1_deserializeOpUpdateCampaignEntryLimits) HandleDeserialize(ctx context.Context, in middleware.DeserializeInput, next middleware.DeserializeHandler) (
	out middleware.DeserializeOutput, metadata middleware.Metadata, err error,
) {
	out, metadata, err = next.HandleDeserialize(ctx, in)
	if err != nil {
	...
	if response.StatusCode < 200 || response.StatusCode >= 300 {
		return out, metadata, awsRestjson1_deserializeOpErrorUpdateCampaignEntryLimits(response, &metadata)
	}
	output := &UpdateCampaignEntryLimitsOutput{}
	out.Result = output
...
func awsRestjson1_deserializeOpErrorUpdateCampaignEntryLimits(response *smithyhttp.Response, metadata *middleware.Metadata) error {
	var errorBuffer bytes.Buffer
	if _, err := io.Copy(&errorBuffer, response.Body); err != nil {
		return &smithy.DeserializationError{Err: fmt.Errorf("failed to copy error response body, %w", err)}
	}
...
func awsRestjson1_deserializeDocumentCampaign(v **types.Campaign, value interface{}) error {
	...
	for key, value := range shape {
		...
		case "entryLimitsConfig":
			if err := awsRestjson1_deserializeDocumentEntryLimitsConfig(&sv.EntryLimitsConfig, value); err != nil {
				return err
			}
...
func awsRestjson1_deserializeDocumentEntryLimitsConfig(v **types.EntryLimitsConfig, value interface{}) error {
	if v == nil {
		return fmt.Errorf("unexpected nil of type %T", v)
	}
	if value == nil {
	...
	var sv *types.EntryLimitsConfig
	if *v == nil {
		sv = &types.EntryLimitsConfig{}
	} else {
		sv = *v
	}
	...
	for key, value := range shape {
		...
		case "maxEntryCount":
			if value != nil {
				...
				sv.MaxEntryCount = ptr.Int32(int32(i64))
			}

		case "minEntryInterval":
			if value != nil {
				jtv, ok := value.(string)
				if !ok {
					return fmt.Errorf("expected Iso8601Duration to be of type string, got %T instead", value)
				}
				sv.MinEntryInterval = ptr.String(jtv)
			}
